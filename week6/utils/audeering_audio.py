...
if __name__ == '__main__':
    ...
    # dummy signal
    sampling_rate = 16000
    audio_path = "/home/georg/projects/university/C5/multimodal_dataset/First_Impressions_v3_multimodal/test/7/2DZb5yIc6Fg.001.wav"
    ...
    print(process_func(SPEECH_WAVEFORM, SAMPLE_RATE))
    #    Age        female     male       child
    # [[ 0.33793038 0.2715511  0.2275236  0.5009253 ]]

    print(process_func(SPEECH_WAVEFORM, SAMPLE_RATE, embeddings=True).shape)
