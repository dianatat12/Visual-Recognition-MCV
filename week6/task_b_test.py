...
model = AgePredictionModel.load_from_checkpoint(checkpoint_path="/home/georg/projects/university/C5/MCV-C5-G4/week6/lightning_logs/frqr6syt/checkpoints/epoch=24-step=600.ckpt", num_classes=7)
...
for batch in test_dl:
    ...
    y_hat = model(images.to('cuda')).detach().cpu().numpy()
...
print(results_df)
results_df.to_csv('task_b_results.csv')